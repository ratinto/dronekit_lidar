...
"""
YDLidar X2 Reader Module
Handles communication with YDLidar X2 sensor
"""
...
class LidarMeasure:
    """Represents a single LiDAR measurement"""
    ...
    def __repr__(self):
        return f"{self.angle:.1f}°: {self.distance:.1f}mm"


class LidarX2:
    """YDLidar X2 2D LiDAR sensor interface"""
    ...
    def open(self):
        ...
        try:
            ...
            print(f"[LiDAR] Error opening port: {e}")
        return False
    ...
    def getMeasures(self):
        """Get current list of measurements"""
    ...
    def __insort_measure(self, l, m, lo=0, hi=None):
        """Insert measure into sorted list by angle"""
        if lo < 0:
    ...
    def __readMeasures(self):
        """Read and parse LiDAR data packet"""
        result = []
